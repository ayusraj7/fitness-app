  ...
  return (
    <div className='w-full  flex flex-col'>
        ...
        <div className='h-auto pb-8 relative flex flex-row w-[90%] lg:w-[85%] mt-[80px] mx-auto  '>          
                    {
                      totalItems>0 && <div className='flex w-[85%] lg:w-[90%] flex-col lg:flex-row justify-between gap-10 '>
                ...
                {
                    totalItems===0 && <div className='w-full text-white flex flex-col gap-10 items-center justify-center'>
