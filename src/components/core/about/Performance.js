            ...
            <div className='flex flex-col lg:flex-row gap-10 mt-8 '>
                <div className='flex flex-col lg:w-[45%] '>
                    ...
                    are modified to fit your individual fitness goals and fitness level.
                        ...
                        your goals and to enjoy your life!
                    </p>
                    <button className='bg-red-500 mt-3 text-white text-[18px] font-medium w-fit px-5 py-3 rounded-md'>FREE CONSULTATION</button>
                </div>
                ...
                <div className='flex lg:w-[55%] flex-wrap '>
                    <div className='lg:w-1/2 p-4 flex flex-col gap-2'>
                        ...
                        <div>
                            <p className='text-[20px] pb-1 font-semibold text-[#384081]'>Body Analysis</p>
                            <div className='h-1 w-[60px] rounded-md bg-red-700 '></div>
                        </div>
                        <p className='text-[#474747] leading-5 tracking-wide text-[16px] w-[90%]'>I usually start my consultations off by performing an in-depth health 
                            assessment, using functional movement screenings and a body composition 
                            analysis, to gauge your most accurate fitness level.</p>
                    </div>
                    <div className='lg:w-1/2 p-4 flex flex-col gap-2'>
                        <img src={photo2} alt="" width={40} height={40} />
                        <div>
                            <p className='text-[20px] pb-1 font-semibold text-[#384081]'>Fitness Programs</p>
                            <div className='h-1 w-[60px] rounded-md bg-red-700 '></div>
                        </div>
                        <p className='text-[#474747] leading-5 tracking-wide text-[16px] w-[90%]'>Once fitness levels have been assessed, I design a custom workout routine
                             for your goals, time constraints, & budget. I encourage, motivate & guide
                             you to reach your health and fitness goals on a personalized level.</p>
                    </div>
                    <div className='p-4 lg:w-1/2 flex flex-col gap-2'>
                        <img src={photo3} alt="" width={40} height={40}/>
                        <div>
                            <p className='text-[20px] pb-1 font-semibold text-[#384081]'>Health and Nutrition</p>
                            <div className='h-1 w-[60px] rounded-md bg-red-700 '></div>
                        </div>
                        <p className='text-[#474747] leading-5 tracking-wide text-[16px] w-[90%]'>As part of my training program, I'll work one-on-one with you as your
                            nutrition coach to develop a meal plan that creates new and sustainable
                            eating habits that still fit your lifestyle & will maximize your fitness goals.</p>
                    </div>
                    <div className='p-4 lg:w-1/2 flex flex-col gap-2'>
                        <img src={photo4} alt="" width={40} height={40} />
                        <div>
                            <p className='text-[20px] pb-1 font-semibold text-[#384081]'>Flexibility</p>
                            <div className='h-1 w-[60px] rounded-md bg-red-700 '></div>
                        </div>
                        <p className='leading-5 text-[#474747] tracking-wide text-[16px] w-[90%]'>My programs are flexible & specifically designed to help you reach your health & fitness goals. 
                            I'll work with you to customize an exercise & meal plan that 
                            reflects not only your short term goals but the long game as well.</p>
                    </div>
