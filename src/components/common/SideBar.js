  ...
  return (
    <>
         <div className='sm:flex pb-10 h-auto flex-col gap-4 px-6 bg-[rgb(253,253,245)] hidden w-[35%] lg:w-[25%] rounded-lg'>
                ...
                <div className='h-6 border-y border-gray-400 w-[90%] text-red-600 mx-auto text-center'>FITNESS BLOGS</div>
                <p className='text-[16px] text-blue-800 px-6'>Fitness is one’s ability to execute daily activities with optimal performance, endurance, and strength with the management of disease, fatigue, and stress.</p>
