        ...
        <div className="fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
          <div className="w-11/12 max-w-[350px] rounded-lg border border-richblack-400 bg-[rgb(22,29,41)] p-6">
            ...
            <div className="flex items-center gap-4">
              <Button text={modalData.btn1Text} onclick={modalData.btn1Handler} css={'text-black hover:bg-yellow-300 transition-all duration-200 bg-yellow-400  cursor-pointer px-3 text-xl text-blue-900 rounded-sm'} />
